    ...
    <section className="py-20 bg-[#0f0f0f] border-y border-white/5">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <FadeUp className="text-center mb-12">
          <p className="text-white/25 text-[10px] tracking-[0.4em] uppercase">Trusted by {"India's"} Leading Brands</p>
        </FadeUp>
        <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-6 lg:gap-x-16">
          {logos.map((logo, i) => (
            <FadeUp key={logo} delay={i * 0.04}>
              <div
                className="text-white/18 hover:text-white/45 font-semibold text-xs tracking-[0.2em] uppercase transition-colors duration-300 cursor-default"
